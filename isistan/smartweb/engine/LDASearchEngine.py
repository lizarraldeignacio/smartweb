...
class LDASearchEngine(SmartSearchEngine):
    #
    # Registry implementation using Latent Dirichlet Allocation

    def __init__(self):
        super(LDASearchEngine, self).__init__()
        self._service_array = []        
    ...
    def _after_publish(self, documents):
        ...
        self._svd_matrix = self._lda.fit_transform(self._tfidf_matrix.toarray())
    ...
    def find(self, query):
        ...
        query_array = self._lda.transform(query_array.toarray())
